...
/* This bundled gSOAP predates OpenSSL 1.1; the build's headers hide the legacy
   1.0.x compatibility layer (OPENSSL_API_COMPAT), so provide minimal shims here.
   The export-grade RSA/DH ephemeral key paths are obsolete in OpenSSL 1.1+ and
   are never taken at runtime for our use, so stubbing them out is safe. */
...
#endif
#ifndef SSL_CTX_need_tmp_RSA
#define SSL_CTX_need_tmp_RSA(ctx) (0)
#endif
#ifndef SSL_CTX_set_tmp_rsa
#define SSL_CTX_set_tmp_rsa(ctx, rsa) (1)
#endif
#ifndef RSA_F4
#define RSA_F4 0x10001L
#endif
#define RSA_generate_key(bits, e, cb, cbarg) ((RSA*)0)
#define RSA_free(rsa) ((void)(rsa))
#define DH_generate_parameters(len, gen, cb, cbarg) ((DH*)0)
#define DH_check(dh, codes) (1)
#define DH_free(dh) ((void)(dh))
#ifndef ASN1_STRING_data
#define ASN1_STRING_data(x) ((unsigned char*)ASN1_STRING_get0_data(x))
#endif
#endif
