...
// Lowered to accept MariaDB Connector/C (reports a 3.x client version) and
// modern MariaDB servers, which this 2018-era check otherwise wrongly rejects.
#define MIN_MYSQL_SERVER_VERSION 30000u
      ...
      _async_threads(0), _synch_threads(0)
{
    ...
    // Disabled for MariaDB Connector/C: it reports its own connector version
    // (e.g. 3.3.x) from mysql_get_client_version(), which never equals the
    // MariaDB server-compat MYSQL_VERSION_ID baked in at compile time.
