    ...
    public:
        ...
        struct boss_siegecrafter_blackfuseAI : public BossAI
        {
                ...
                m_WeaponSpawnHelper(creature)
            {
                ...
                me->SetFloatValue(UNIT_FIELD_COMBATREACH, 6.f);
            }
        ...
        private:
            ...
            void DoUseLaserTurret()
            {
                if (IsOvercharged())
                {
                    ...
                    CreateLaserCirclePath(20.f, 2 * M_PI);
                    CreateLaserCirclePath(40.f, M_PI / 2);
                    CreateLaserCirclePath(60.f, 3 * M_PI / 2);
                }
                else
                {
            ...
            void CreateLaserCirclePath(float radius, float skipAngle)
            {
                ...
                const float step = -M_PI / (sectors / 2);
        ...
        private:
            ...
            void CreateNewCrawlerMines(uint8 count)
            {
                ...
                for (uint8 i = 0; i < count; ++i)
                {
                    ...
                    {
                        pMine->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC);
