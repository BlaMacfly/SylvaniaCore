...
// 137121 
class spell_reckless_charge_initialize : public SpellScriptLoader
{
public:
    spell_reckless_charge_initialize() : SpellScriptLoader("spell_reckless_charge_initialize") {}

    class spell_reckless_charge_initialize_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_reckless_charge_initialize_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_reckless_charge_initialize_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_reckless_charge_initialize_AuraScript::HandleRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_reckless_charge_initialize_AuraScript::HandlePeriodic, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY); // CUSTOM FREAKZ DBC
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_reckless_charge_initialize_AuraScript();
    }
};

// 137579
class spell_biting_cold_immunities : public SpellScriptLoader
{
public:
    spell_biting_cold_immunities() : SpellScriptLoader("spell_biting_cold_immunities") {}

    class spell_biting_cold_immunities_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_biting_cold_immunities_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_biting_cold_immunities_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_biting_cold_immunities_AuraScript::HandleRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_biting_cold_immunities_AuraScript();
    }
};
...
class npc_twisted_fate_first : public CreatureScript
{
public:
    npc_twisted_fate_first() : CreatureScript("npc_twisted_fate_first") {}

    class npc_twisted_fate_firstAI : public ScriptedAI
    {
    public:
        npc_twisted_fate_firstAI(Creature* creature) : ScriptedAI(creature)
        {
    ...
    {
        return new npc_twisted_fate_firstAI(creature);
    }
};

class npc_twisted_fate_second : public CreatureScript
{
public:
    npc_twisted_fate_second() : CreatureScript("npc_twisted_fate_second") {}

    class npc_twisted_fate_secondAI : public ScriptedAI
    {
    public:
        npc_twisted_fate_secondAI(Creature* creature) : ScriptedAI(creature)
        {
            me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_MOD_TAUNT, true);
            me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_ATTACK_ME, true);
            me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_MOD_THREAT, true);
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_twisted_fate_secondAI(creature);
    }
};

// 137629
class spell_treacherous_ground : public SpellScriptLoader
{
public:
    spell_treacherous_ground() : SpellScriptLoader("spell_treacherous_ground") {}

    class spell_treacherous_ground_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_treacherous_ground_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_treacherous_ground_AuraScript::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    ...
    AuraScript* GetAuraScript() const
    {
        return new spell_treacherous_ground_AuraScript();
    }
};

// 137085
class spell_chilled_to_the_bone : public SpellScriptLoader
{
public:
    spell_chilled_to_the_bone() : SpellScriptLoader("spell_chilled_to_the_bone") {}

    class spell_chilled_to_the_bone_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_chilled_to_the_bone_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_chilled_to_the_bone_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_chilled_to_the_bone_AuraScript::HandleRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_chilled_to_the_bone_AuraScript();
    }
};
...
class spell_soul_fragment_shadowed_soul : public SpellScriptLoader
{
public:
    spell_soul_fragment_shadowed_soul() : SpellScriptLoader("spell_soul_fragment_shadowed_soul") {}

    class spell_soul_fragment_shadowed_soul_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_soul_fragment_shadowed_soul_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_soul_fragment_shadowed_soul_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_OVERRIDE_SPELLS, AURA_EFFECT_HANDLE_REAL);
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_soul_fragment_shadowed_soul_AuraScript::OnPeriodic, EFFECT_1, SPELL_AURA_PERIODIC_DAMAGE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_soul_fragment_shadowed_soul_AuraScript();
    }
};

// Reckless Charge immunities ( some failsafes ) - 137124 ( main spell )
class spell_reckless_charge_failsafe : public SpellScriptLoader
{
public:
    spell_reckless_charge_failsafe() : SpellScriptLoader("spell_reckless_charge_failsafe") {}

    class spell_reckless_charge_failsafe_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_reckless_charge_failsafe_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_reckless_charge_failsafe_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_reckless_charge_failsafe_AuraScript::HandleRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_reckless_charge_failsafe_AuraScript();
    }
};

// Reckless Charge - 137122, 137133
class spell_reckless_charge_spell_onhit_script : public SpellScriptLoader
{
public:
    spell_reckless_charge_spell_onhit_script() : SpellScriptLoader("spell_reckless_charge_spell_onhit_script") {}

    class spell_reckless_charge_spell_onhit_script_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_reckless_charge_spell_onhit_script_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_reckless_charge_spell_onhit_script_SpellScript::HandleOnHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_reckless_charge_spell_onhit_script_SpellScript();
    }
};
...
void AddSC_boss_council_of_elders()
{
    ...
    new spell_reckless_charge_initialize();
    new spell_biting_cold_immunities();
    new npc_twisted_fate_second();
    new npc_twisted_fate_first();
    new spell_treacherous_ground();
    new spell_chilled_to_the_bone();
    new spell_soul_fragment_shadowed_soul();
    new spell_reckless_charge_spell_onhit_script();
    new spell_reckless_charge_failsafe();
