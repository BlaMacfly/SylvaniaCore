...
struct boss_fallen_avatar : BossAI
{
    ...
    void JustDied(Unit* /*killer*/) override
    {
        ...
        ; // CreateConversation : cinematique de conversation, non portee
            ...
            switch (eventId)
            {
                ...
                case EVENT_SELECT_PILONE:
                    ...
                    if (!pilones.empty())
                    {
                        ...
                        if (!freePilones.empty())
                        {
                            ...
                            if (Creature* summon = ObjectAccessor::GetCreature(*me, freePilones[i]->first))
                ...
                case EVENT_SELECT_PILONE_FEL:
                {
                    if (!pilones.empty())
                    {
                        ...
                        if (!freePilones.empty())
                        {
                            ...
                            {
                                if (Creature* summon = ObjectAccessor::GetCreature(*me, pair->first))
                ...
                case EVENT_RUPTURE_REALISTIC_AND_ENERGY:
                    ...
                    if (isSecondPhase)
                        ...
                        {
                            float tz = me->GetMap()->GetHeight(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), false, MAX_FALL_DISTANCE);
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_1:
                ...
                {
                    me->CastCustomSpell(SPELL_CLEANING_PROTOCOL_ABSORB, SPELLVALUE_BASE_POINT0, int32(me->GetMaxHealth() * 0.05f), me);
...
class spell_tos_shadow_blades : public SpellScript
{
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(spell_tos_shadow_blades::HandleDummy, SpellEffIndex::EFFECT_0, SpellEffectName::SPELL_EFFECT_DUMMY);
    }
};
